...
#include "FlyWindow/FlyWindow.h"
#include "FlyWindow/FlyRenderer.h"
#include "FlyWindow/Widget/FlyWidget.h"
#include "FlyWindow/Widget/FlyLabel.h"
...
int SystemInit()
{
    return SDL_Init(SYSTEM_INIT_EVERYTHING);
}

#define GameInit SystemInit
